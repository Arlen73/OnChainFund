...
ARG VITE_ENTRANCE_RATE_DIRECT_FEE_ADDRESS
ARG VITE_ALLOWED_DEPOSIT_RECIPIENTS_POLICY_ADDRESS
...
ENV VITE_ENTRANCE_RATE_DIRECT_FEE_ADDRESS=$VITE_ENTRANCE_RATE_DIRECT_FEE_ADDRESS
ENV VITE_ALLOWED_DEPOSIT_RECIPIENTS_POLICY_ADDRESS=$VITE_ALLOWED_DEPOSIT_RECIPIENTS_POLICY_ADDRESS
